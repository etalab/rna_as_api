...
# 'Montpellier' search have ~7K results. If we find over 6K, we can assume database is correctly filled.
class TestSelfServer < RNAAsAPIInteractor
  ...
  def execute_test
    `curl --resolve entreprise.data.gouv.fr:443:127.0.0.1 https://entreprise.data.gouv.fr/api/rna/v1/full_text/montpellier`
  rescue StandardError => e
