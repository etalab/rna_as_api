...
class AssociationImportAttrsFromLine
  include Singleton

  def call(line)
    association_import_attrs = {
      is_waldec: 'false',
      ...
      l1_adresse_import: line[:adr1],
      l2_adresse_import: line[:adr2],
      l3_adresse_import: line[:adr3],
      adresse_code_postal: line[:adrs_codepostal],
      adresse_libelle_commune: line[:libcom],
    ...
    # Lines present in waldec and not in import :
    ...
    # Lines present in import and not in waldec :
    # l1_adresse_import: line[:adr1],
    # l2_adresse_import: line[:adr2],
    # l3_adresse_import: line[:adr3],
