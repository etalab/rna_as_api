class DeleteDatabase < RNAAsAPIInteractor
  ...
  def self.all
    RNAAsAPIInteractor.new.stdout_info_log 'Database waldec and import will be deleted'
    ...
    RNAAsAPIInteractor.new.stdout_success_log 'Database waldec and import successfully deleted'
  end
